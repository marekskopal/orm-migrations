...
#[CoversClass(MySqlAlterColumn::class)]
final class MySqlAlterColumnTest extends TestCase
{
    ...
    {
        $query = new MySqlAlterColumn($name, $type, $nullable, $autoincrement, $primary, $size, $precision, $scale, $enum, $default);
